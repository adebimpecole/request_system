...
const RequestCard = ({ data }) => {
  ...
  return (
    <div
      className="sm:p-5 shadow p-4 border-gray-200 border bg-white rounded-lg absolute right-0 w-[25rem]"
      style={{
    ...
    >
      ...
      <dl className="sm:mb-5 mb-4 w-full">
        ...
        <dd className="text-gray-500 font-light items-center flex mb-2 w-full">
          ...
          <span className="text-black font-medium">${data?.content.amount}</span>
        </dd>
        ...
        <dd className="sm:mb-5 text-gray-500 font-light items-center flex mb-4 w-full">
          ...
          <span className="text-black font-medium">
            {getDate(data?.content.dateCreated)}
          </span>
        </dd>
