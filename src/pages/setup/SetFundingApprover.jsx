...
const SetFundingApprover = ({ Set, approver }) => {
    ...
    <div className="space-y-5">
      <div>
        <p className="text-sm text-slate-500 leading-relaxed">
          The funding approver has final authority to authorize or decline a disbursement. Select one approver for this role.
        </p>
      </div>
      ...
      {selected && (
        <div className="flex items-center gap-2 bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3">
          ...
          <p className="text-sm text-emerald-700 font-medium">
            <span className="font-semibold">{selected}</span> set as Funding Approver
          </p>
        </div>
      )}
    </div>
...
export default SetFundingApprover;
